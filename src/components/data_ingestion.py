...
@dataclass
class DataIngestionConfig:  # in components another python script can be  written for configuration
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            # you can use any other way to read the data like mongodb, sql etc.
