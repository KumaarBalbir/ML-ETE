# this file will be used to transform the data after the data ingestion step
...
class DataTransformationConfig:
    # preprocessor.pkl file is created in artifacts folder. it represents the preprocessor object
